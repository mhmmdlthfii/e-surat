        ...
        <div className="flex flex-col md:flex-row md:items-center gap-3">
          ...
          <div className="relative flex-1">
            ...
            <input 
              ...
              className="w-full bg-white dark:bg-zinc-950 pl-10 pr-4 py-2 border border-zinc-200 dark:border-zinc-800 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20"
            />
          </div>

          <div className="flex flex-wrap items-center gap-2">
            {/* Filter Module */}
            <div className="flex items-center space-x-1 border border-zinc-200 dark:border-zinc-800 rounded-xl px-2.5 py-1 bg-white dark:bg-zinc-950 text-xs">
              ...
              >
                {modules.map((m, idx) => (
                  <option key={idx} value={m} className="bg-white dark:bg-zinc-900">{m === 'Semua' ? 'Semua Modul' : m}</option>
                ))}
              </select>
            </div>
